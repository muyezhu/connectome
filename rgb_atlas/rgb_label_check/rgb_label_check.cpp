 ...
 int index_valid(int i)
{
 ...
 {
    if (rgb_index == border_index[0] || rgb_index == border_index[1] || rgb_index == border_index[2] || 
	    rgb_index == border_index[3] || rgb_index == border_index[4] || rgb_index == border_index[5]
		|| rgb_index == border_index[6]) 
	    return true;
	return false;
 }
